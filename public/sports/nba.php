...
echo "<link>http://www.nba.com</link>\n";
echo "<description>NBA Scores</description>\n";
echo "<language>en-us</language>\n";
echo "<image>\n";
echo " <title>NBA Scores</title>\n";
echo " <url>http://www.mpiii.com/scores/nba.gif</url>\n";
echo " <link>http://www.nba.com</link>\n";
echo "</image>\n";
echo "<webMaster>info@nba.com</webMaster>\n";
